...
[NOAA's Ocean Prediction Center](https://ocean.weather.gov/) provides a FTP server](https://ftp.opc.ncep.noaa.gov/grids/experimental/GStream) for downloads by year.  We have downloaded these and repackaged into spatial format files - these are included with the `gstream` package.
